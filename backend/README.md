...
## Project Structure
    ...
    ├── billowing_union_dev_61356  # Django project configurations
...
1. Clone this repo and `cd billowing_union_dev_61356`
...
2. Clone this repo and `cd billowing_union_dev_61356`
